...
.then(function(res){
    ...
    mokeponEnemigo = new Mokepon('Hipodoge',"./img/hipodoge_cabeza.png",5,"./img/hipodoge.png", enemigo.id)
}else if(mokeponNombre==="Capipepo"){
    mokeponEnemigo = new Mokepon('Capipepo',"./img/capipepo_cabeza.png",5,"./img/capipepo.png", enemigo.id)
}else if(mokeponNombre==="Ratigueya"){
    mokeponEnemigo = new Mokepon('Ratigueya',"./img/ratigueya_cabeza.png",5,"./img/ratigueya.png", enemigo.id)}
